...
def ventricular_premature_image_generation():
    ...
    for e in paths:
        ...
        for count, i in enumerate(imp_beats):
            ...
            if(j!=0 and j!=(len(beats)-1)):
                ...
                ventricular_premature.append(signals[beats[j] - diff1: beats[j] + diff2, 0])
                #print(Normal[count])


    for count, i in enumerate(ventricular_premature):
        print('jentre')
        ...
        filename = './images_ventricular_premature' + '/' + str(count)+'.png'
