...
def atrial_premature_image_generation():
    ...
    for e in paths:
        ...
        for count, i in enumerate(imp_beats):
            ...
            if(j!=0 and j!=(len(beats)-1)):
                ...
                atrial_premature.append(signals[beats[j] - diff1: beats[j] + diff2, 0])
                #print(Normal[count])


    for count, i in enumerate(atrial_premature):
        ...
        filename = './images_atrial_premature' + '/' + str(count)+'.png'
