...
def right_bundle_image_generation():
    ...
    for e in paths:
        ...
        for count, i in enumerate(imp_beats):
            ...
            if(j!=0 and j!=(len(beats)-1)):
                ...
                right_bundle.append(signals[beats[j] - diff1: beats[j] + diff2, 0])
                #print(Normal[count])


    for count, i in enumerate(right_bundle):
        print('jentre')
        ...
        filename = './images_right_bundle' + '/' + str(count)+'.png'
