...
def paced_beat_image_generation():
    ...
    for e in paths:
        ...
        for count, i in enumerate(imp_beats):
            ...
            if(j!=0 and j!=(len(beats)-1)):
                ...
                paced_beat.append(signals[beats[j] - diff1: beats[j] + diff2, 0])
                #print(Normal[count])


    for count, i in enumerate(paced_beat):
        print('jentre')
        ...
        filename = './images_paced_beat' + '/' + str(count)+'.png'
